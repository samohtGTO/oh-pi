...
// Note: Using Type.Any() for Google API compatibility (doesn't support anyOf)
export const ChainItem = Type.Any({
...
export const SubagentParams = Type.Object({
	...
	output: Type.Optional(
		Type.Any({
			description:
				"Override output file for single agent (string), or false to disable (uses agent default if omitted). Absolute paths are used as-is; relative paths resolve against cwd.",
		}),
	),
	skill: Type.Optional(SkillOverride),
	model: Type.Optional(
