...
export const DEFAULT_RECURRING_EXPIRY_MS = ONE_DAY;
export const MAX_RECURRING_EXPIRY_MS = ONE_DAY;
...
export const SCHEDULER_LEASE_HEARTBEAT_MS = 1000;
export const SCHEDULER_SAFE_MODE_HEARTBEAT_MS = 5000;
